...
val fakeCardList = listOf(
    ...
    CardDto(8, "What is Room?", "A database library", "Used for SQLite in Android", "2024-02-04"),
    CardDto(9, "What is Retrofit?", "A type-safe HTTP client", "Used for API calls", "2024-02-04"),
    CardDto(
        10,
        "What is Flow?",
...
val fakeProfileEntity = ProfileEntity(
    uid = "uid",
    userName = "userName",
    email = "email",
    bio = "bio",
...
val fakeDeckDetailDto = DeckDetailDto(
    deckDto = fakeDeckDto,
    profileEntity = fakeProfileEntity,
)