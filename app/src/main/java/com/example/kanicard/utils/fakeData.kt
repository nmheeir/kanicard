...
val fakeListDecks = listOf(
    DeckEntity(
        ...
        userId = 101,
        title = "Kotlin Basics",
        thumbnail = "https://www.shutterstock.com/shutterstock/photos/1800970357/display_1500/stock-vector-people-are-gathering-around-a-huge-random-box-flat-design-style-minimal-vector-illustration-1800970357.jpg",
        description = "Learn the basics of Kotlin programming language. Perfect for beginners.",
        isPublic = true,
        createdAt = LocalDateTime.of(2023, 12, 5, 14, 30, 0, 0)
    ),
